...
public class CategoryController {
	...
	//delete
		@DeleteMapping("/{catId}")
		public ResponseEntity<ApisResponce> deleteCategory(@PathVariable Integer catId){
			 
		categoryService.deleteCategory(catId);
			
			return new ResponseEntity<ApisResponce>(new ApisResponce("Message is deleted successfully", true),HttpStatus.OK);
	}
		//get
		@GetMapping("/{catId}")
	...
	//getAll
		@GetMapping("/")
			public ResponseEntity<List<CategoryDto>> getAllCategries(){
